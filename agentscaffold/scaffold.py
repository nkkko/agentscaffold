...
def create_new_agent(
    ...
    for file_name in ["README.md.jinja", ".env.example.jinja", "main.py.jinja", 
                    "requirements.in.jinja", "pyproject.toml.jinja"]:
        _render_template_file(os.path.join(template_dir, file_name), agent_dir, context)
