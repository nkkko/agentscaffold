...
"""
    ...
    def _get_required_packages(self, agent_dir: str) -> List[str]:
        ...
        if not requirements_file.exists():
            # Only include packages that are published on PyPI
            return ["pydantic", "pydantic-core", "daytona-sdk", "python-dotenv", "openai"]
        
        # Always include these essential packages that are available on PyPI
        # Note: Remove agentscaffold since it's not yet published on PyPI
